...
"""
from sqlalchemy import Column, Integer, String, Float, Boolean, ForeignKey, Text, JSON, Enum as SQLEnum, Date
...
class Product(BaseModel):
    ...
    expiry_date = Column(Date, nullable=True)  # Жарамдылық мерзімі (срок годности)
