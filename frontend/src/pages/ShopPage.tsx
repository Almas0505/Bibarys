...
export default function ShopPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Тауарлар каталогы</h1>

      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* Filters Sidebar */}
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
            <h2 className="text-xl font-bold mb-4">Сүзгілер</h2>

            {/* Search */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Іздеу</label>
              <input
                type="text"
            ...
            {/* Category */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Санат</label>
              <select
                aria-label="Санатты таңдаңыз"
            ...
            {/* Price Range */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Бағасы</label>
            ...
            {/* Sort */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Сұрыптау</label>
              <select
                aria-label="Сұрыптауды таңдаңыз"
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg"
              >
                <option value="created_at_desc">Алдымен жаңалары</option>
                <option value="price_asc">Алдымен арзандары</option>
                <option value="price_desc">Алдымен қымбаттары</option>
                <option value="rating_desc">Рейтинг бойынша</option>
              </select>
            </div>
        ...
        <div className="lg:col-span-3">
          {isLoading ? (
            <LoadingSpinner text="Тауарлар жүктелуде..." />
          ) : products.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">Тауарлар табылған жоқ</p>
            </div>
          ) : (
            <>
              ...
              {pagination.total_pages > 1 && (
                <div className="flex items-center justify-center space-x-2 mt-8">
                  ...
                  <span className="text-gray-600">
                    Бет {pagination.page} / {pagination.total_pages}
                  </span>
                  <button
                    onClick={() => handlePageChange(pagination.page + 1)}
