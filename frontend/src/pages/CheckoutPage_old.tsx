...
export default function CheckoutPage() {
  ...
  const deliveryOptions = [
    { value: 'pickup', label: '🏪 Самовывоз из магазина', price: 0, days: 'Сегодня', description: 'Бесплатно, получите в тот же день' },
    { value: 'delivery', label: '🚚 Доставка курьером', price: 500, days: '1-2 дня', description: 'Доставим по указанному адресу' },
  ];

  // Payment options
  const paymentOptions = [
    { value: 'cash', label: '💰 Наличные', description: formData.deliveryMethod === 'pickup' ? 'Оплата в магазине при получении' : 'Оплата курьеру при получении' },
    { value: 'wallet', label: '💳 Виртуальный кошелек', description: `Баланс: ${formatPrice(walletBalance)}` },
  ];
