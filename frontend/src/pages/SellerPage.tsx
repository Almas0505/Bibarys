...
export default function SellerPage() {
  ...
  const sellerProducts = products.filter((p: Product) => p.seller_id === user?.id);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">
                {sellerProducts.reduce((sum: number, p: Product) => sum + p.quantity, 0)}
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">
                {sellerProducts.reduce((sum: number, p: Product) => sum + p.view_count, 0)}
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">
                {sellerProducts.reduce((sum: number, p: Product) => sum + p.review_count, 0)}
              </p>
            </div>
          ...
          <p className="text-gray-600 text-sm mt-2">
            ⭐ {sellerProducts.length > 0 
              ? (sellerProducts.reduce((sum: number, p: Product) => sum + p.rating, 0) / sellerProducts.length).toFixed(1)
              : '0.0'}
          </p>
        </div>
      </div>
